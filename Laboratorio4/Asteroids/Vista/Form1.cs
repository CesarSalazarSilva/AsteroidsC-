...
namespace Vista
{
    public partial class Form1 : Form
    {
        ...
        private void ButtonPlay_Click(object sender, EventArgs e)
        {
            ...
            if ((numparticiones >= 1 && 7 >= numparticiones) && (anchoN *largoM * 0.5 > AsteroidesA * Math.Pow(Space.hitboxAsteroide, 2) * Space.PI) && seed>= 0 && recorridoFR >= 0 && AsteroidesA >= 0 && anchoN >= 0 && largoM >=0)
            {
                ...
                Console.WriteLine("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
                //Se esconde la pestaña de solicitud de datos
                this.Hide();
