...
namespace Vista
{
    public partial class Form2 : Form
    {
        ...
        public Form2(Space juego)
        {
            ...
            //Posicion de botones Jugabilidad
        ...
        private void drawSpace()
        {
            ...
            if (Status == 1) {
                ...
                g.FillEllipse(new SolidBrush(Color.White), (float)this.juego.Nave.PosX, (float)this.juego.Nave.PosY, (float)this.juego.Nave.Hitbox*10, (float)this.juego.Nave.Hitbox*10);
